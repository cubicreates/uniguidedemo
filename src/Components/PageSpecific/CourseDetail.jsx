    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <div className="container mx-auto p-6">
                ...
                <CourseBanner name="All Contents" videos={0} exercises={0} notes={0} to={"/uniguidedemo/Fields/Engineering-and-Technology/Courses/Full-Stack-Development/All-Contents"} />
